...
type Tab = 'concepts' | 'traps' | 'checklist' | 'refs'
...
export function StudyGuide() {
  ...
  return (
    <div className="container-page py-14 sm:py-16">
      <SectionHeading
        eyebrow="Notes from my prep"
        title="Study Guide"
        subtitle="The concepts, traps, and a quick checklist I kept coming back to. Pair it with the mock exams — these notes are the ‘why’, the questions are the ‘can you apply it’."
      />
